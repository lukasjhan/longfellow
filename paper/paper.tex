...
for Galaxy, 8\,GB RAM) under Termux---identical circuits and the same median methodology.
Table~\ref{tab:mobile} reports it. \emph{Mobile proving is practical:} every configuration
proves in under 2.1\,s and verifies in under 1\,s, comparable to the 2018 desktop and, on
the smaller mdoc circuits, faster (a 2023 mobile SoC against a 2018 desktop part); the
...
platform artifact---about 5\% of the phone's 8\,GB. \emph{Thermal note:} a compact foldable
throttles under sustained back-to-back runs (which inflated SD-JWT proving by
$\approx$30\%); since a wallet presentation is a one-shot burst, we report numbers with the
device cooled between configurations, as deployment-representative.

\begin{table}[t]\centering\small
\caption{Mobile prover: Samsung Galaxy Z Flip5 (Snapdragon 8 Gen~2, 8\,GB), median of 3,
cooled between configurations. Peak RSS is the proof system's working set and matches the
desktop (Table~\ref{tab:eval}'s hardware) within noise.}
\label{tab:mobile}
\begin{tabular}{@{}llrrrr@{}}
\toprule
Format & Feature & Prove & Verify & Proof & Peak RSS \\
       &         & (ms)  & (ms)   & (KB)  & (MB) \\
\midrule
SD-JWT VC & base (SD + sig)        & 1577 & 713 & 391 & 372 \\
SD-JWT VC & + nullifier            & 1869 & 882 & 394 & 395 \\
SD-JWT VC & + \textbf{blind} null. & 2006 & 947 & 395 & 403 \\
SD-JWT VC & + revocation           & 2061 & 983 & 412 & 397 \\
ISO mdoc  & + nullifier            & \phantom{0}712 & 339 & 344 & 180 \\
ISO mdoc  & + \textbf{blind} null. & \phantom{0}759 & 389 & 346 & 187 \\
ISO mdoc  & + revocation           & \phantom{0}944 & 461 & 360 & 182 \\
\bottomrule
\end{tabular}
\end{table}

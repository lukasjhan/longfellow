...
nullifier. Our theorems are asymptotic; the concrete soundness and knowledge error are
those of longfellow's Ligero+sumcheck instantiation over $\mathrm{GF}(2^{128})$, adopted
unchanged and not re-derived here. As longfellow is recent, that concrete analysis has a

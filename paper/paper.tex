...
binds a verifier's scope and an epoch, so distinct scopes yield independent nullifiers.
...
account per service)---while no other party can induce that collision. This

...
KB-JWT over $e_2$ (\S\ref{sec:frontend})---so the 3{,}739-input base already includes
the device signature; revocation adds a \emph{third}, the CRA span, growing it to
5{,}288 inputs and the bundle by $\approx$15\,KB, while prove/verify move within noise. \emph{Proof size} is
